...
<!--                        </el-form-item>-->
                        <el-form-item label="原寄地">
                            <el-input
                                :placeholder="this.form.departAddress"
                                :readonly="true">
                            </el-input>
                        </el-form-item>
                        <el-form-item label="收件地址">
                            <el-input
                                :placeholder="this.form.destinationAddress"
                                :readonly="true">
                            </el-input>
                        </el-form-item>
                    </el-form>
    ...
    methods:{
        ...
        test(){
            this.form.name='123',
                ...
                this.form.departAddresscode='湖南省长沙市长沙县兴东村',
                this.form.destinationAddresscode='北京市海淀区北京交通大学'
        ...
        onSubmit(){
            ...
            // }
               ...
               /* let str = this.form.departAddresscode;
                let departAddresscode = str.toString().split(",");
                let str2 = this.form.destinationAddresscode;
                let destinationAddresscode =  str2.toString().split(",");*/

                this.cost=this.form.weight*6;
                this.form.departAddress=this.form.departAddresscode;
                this.form.destinationAddress=this.form.destinationAddresscode;
                /*this.form.departAddress=this.getCodeToText(departAddresscode);
                this.form.destinationAddress=this.getCodeToText(destinationAddresscode);*/
