...
export default {
    ...
    methods:{
        topage1(){
            ...
            //     }
            // });
            router.push({path:'/mainpage',query: {username:this.username,
        ...
        topage2(){
            ...
            router.push({path:'/searchBill',query: {username:this.username,
                    id:this.id,email:this.email}})
        },
        topage3(){
            /*this.$router.push({
            ...
            router.push({path:'/goodsSituation',query: {username:this.username,
                    id:this.id,email:this.email}})
        },
        topage4(){
